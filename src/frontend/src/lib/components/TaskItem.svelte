...
<div id={task.id} class="item-grid p-1 bg-neutral-600 rounded-md">
    ...
    <span style="grid-area:progress">Progress: {task.progress}/{(task.total > 0)? task.total : "?"}</span>
    <button class="{btn_shared_classes} mx-2" style="grid-area:close" title="Close Task">
